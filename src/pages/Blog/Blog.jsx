  ...
  return (
    <div className="ml-56 me-56">
      ...
      <p>
        ...
        <br />
        Context API in React is to share data or the app state across all the
        app components. This means that the props can be accessed from any
        component. Therefore, no need to pâss props through other components to
        send it at the end to our destination component. Less code, less
        debugging hassle, and more code visibility.
      </p>
      ...
      <p>
        ...
        an object having a special property current.reference.
        <br />
        current accesses the reference value, and reference.current = newValue
        updates the reference value. Pretty simple.
      </p>
